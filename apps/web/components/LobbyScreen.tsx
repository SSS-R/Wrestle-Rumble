                    ...
                    <section className="space-y-4">
                        <div className="grid gap-4 md:grid-cols-3">
                            {actionCards.map((card) => (
                                ...
                                >
                                    ...
                                    <h2 className="mt-4 font-[var(--font-heading)] text-3xl uppercase text-white">{card.title}</h2>
                                    <p className="mt-3 max-w-xs text-sm leading-7 text-zinc-300">{card.text}</p>
                                    <Link href={card.href} className="mt-8 rounded-full border border-white/15 bg-black/35 px-4 py-2 text-xs font-bold uppercase tracking-[0.24em] text-white inline-block">
                                        {card.cta}
                                    </Link>
                                </article>
                            ))}
                        ...
                        <article className="metal-panel chrome-border slide-in-panel relative overflow-hidden rounded-[30px] px-6 py-7">
                            ...
                            <div className="mt-4 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                                <div>
                                    <h2 className="font-[var(--font-display)] text-4xl uppercase md:text-5xl">WrestleMania Season Clash</h2>
                            ...
                            <article className="metal-panel chrome-border slide-in-panel rounded-[28px] p-5">
                                ...
                                <div className="mt-5 space-y-3">
                                    {leaderboard.length > 0 ? (
                                        ...
                                        <div className="text-center py-4 text-sm text-[var(--text-secondary)]">No leaderboard data</div>
                                    )}
                                </div>
                            </article>
                        </section>
